...
protected:
    ...
    void replace_expr(std::unique_ptr<expr> replacement);
    void replace_expr(expr_list replacements);

private:
    bool has_expr_replacements_ = false;
    expr_list expr_replacements_;
    expr_list take_expr_replacements();
};
